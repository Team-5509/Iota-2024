...
public class ShootAtPercentSpeed extends Command {
    ...
    public ShootAtPercentSpeed(boolean aut, double percentSpeed, Shooter subsystem) {
        ...
        m_shooter.shootAuto(percentSpeed);
    }
    ...
    @Override
    public void execute() {
        double factor = RobotContainer.getInstance().getdriverXbox().getLeftTriggerAxis();
        if(factor < .1){
            factor = 0;
        }
