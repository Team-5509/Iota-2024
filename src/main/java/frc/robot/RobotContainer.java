...
private final XboxController driverXbox = new XboxController(0);
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("ShootAmp", new ShootAmp( m_shooter ));
...
// Create some buttons
final JoystickButton ampShot = new JoystickButton(auxController, XboxController.Button.kB.value);        
ampShot.whileTrue(new ShootAmp( m_shooter ).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
